...
global.score += 100
	...
	instance_destroy(other)
	instance_create_depth(other.x,other.y,other.depth,obj_smoke,{sprite_index: spr_bulletBreak, direction: direction, image_angle: image_angle,image_xscale:image_xscale*-2,image_yscale:image_yscale*2})
	}
}